...
//             {
//                 int start = pos;
//                 while (pos < input.Length && IsSpecialSymbol(input[pos]))
//                     pos++;
//
//                 string value = input.Substring(start, pos - start);
//                 tokens.Add(new Token { 
...
//     {
//         // Допустимые символы, которые НЕ считаем ошибкой
//         var validSymbols = new HashSet<char> { '+', '-', '*', '/', '(', ')', '{', '}', ':', ',', ';', '_' };
//         
//         // Если символ не буква, не цифра и не в списке допустимых - это ошибка
//         return !char.IsLetterOrDigit(c) && !validSymbols.Contains(c) && !char.IsWhiteSpace(c);
//     }
// }
//
//
